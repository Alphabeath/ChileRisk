...
function PopupCloseButton({ onClick }: { onClick: () => void }) {
  return (
    <button
      ...
      className="focus-visible:ring-ring hover:bg-muted text-foreground absolute top-1 right-1 z-10 inline-flex size-5 cursor-pointer items-center justify-center rounded-none transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-inset"
    >
...
function ControlGroup({ children }: { children: ReactNode }) {
  return (
    <div
      className={cn(
        "border-border bg-background/80 flex w-fit flex-col overflow-hidden rounded-none border shadow-sm backdrop-blur-xl supports-[backdrop-filter]:bg-background/70 [&>button:not(:last-child)]:border-border [&>button:not(:last-child)]:border-b",
        SURFACE_MICA_INTERACTIVE_CLASS,
      )}
    >
      {children}
...
function ControlButton({
  ...
  return (
    <button
      ...
      type="button"
      className={cn(
        "flex size-8 items-center justify-center rounded-none text-muted-foreground transition-colors hover:bg-muted hover:text-foreground focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-inset focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50",
      )}
      disabled={disabled}
    >
      {children}
  ...
  return (
    <ControlButton onClick={onClick} label="Reset bearing to north">
      ...
      >
        ...
        <path d="M12 2L8 12H12V2Z" className="fill-[var(--secondary-chile)]/60" />
